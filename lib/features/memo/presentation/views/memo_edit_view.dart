...
class MemoEditView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(memoEditViewModelProvider(memo));
    final viewModel = ref.read(memoEditViewModelProvider(memo).notifier);
    ...
    return Container(
      ...
      child: Column(
        children: [
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              GestureDetector(
                                onTap: state.linkController.text.trim().isEmpty
                                    ? null
                    ...
                    Visibility(
                      ...
                      child: LinkPreview(
                        links: state.links
                            ...
                            .toList(),
                        onDeleteTap: (index) => viewModel.removeLink(index),
                      ),
                    ),
          ...
          WritingMenuBar(
            onCameraTap: () => viewModel.takePicture(context),
